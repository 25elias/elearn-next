...
export default function EventSnippet({events}) {
    return(
        <div>
        {events.map(({ title, image, author, release_date, content, id }) => (
          <div key={id} className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-10 md:gap-4 mb-4">
